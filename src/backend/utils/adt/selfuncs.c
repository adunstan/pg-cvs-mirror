 ...
 *
 * IDENTIFICATION
 *	  $Header: /home/cvsmirror/pg/pgsql/src/backend/utils/adt/selfuncs.c,v 1.119.2.10 2007/01/03 22:40:04 tgl Exp $
 *
 *-------------------------------------------------------------------------
 */
...
string_to_bytea_const(const char *str, size_t str_len)
{
	...
	return makeConst(BYTEAOID, -1, conval, false, false, false, false);
}
